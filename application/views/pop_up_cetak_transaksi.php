...
<script>
    ...
    function KirimData(file) {
        ...
        console.log(data)
        $.ajax({
            url: "<?php echo base_url(); ?>transaksi/Cetak" + file + "/" + tgl1 + "/" + tgl2 + "/" + nomor, // + tgl1 + "=" + tgl2 + "=" + nomor,
            type: "POST",
            data: data,
        ...
        function PopSuccess() {
            ...
            window.open("<?php echo base_url(); ?>transaksi/Cetak" + file + "/" + tgl1 + "/" + tgl2 + "/" + nomor /* + tgl1 + "=" + tgl2 + "=" + nomor*/ , "_blank")
        }
